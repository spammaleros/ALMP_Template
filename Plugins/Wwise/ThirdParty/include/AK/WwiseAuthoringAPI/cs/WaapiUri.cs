	...
	public class wwise
	{
		...
		public class core
		{
			...
			public class log
			{
				...
				/// <summary>Retrieve the latest log for a specific channel. Refer to \ref ak_wwise_core_log_itemadded to be notified when a item is added to the log.</summary>
			...
			public class @object
			{
				...
				/// <summary>Performs a query, returns specified data for each object in query result. Refer to \ref waapi_query for more information.</summary>
		...
		public class ui
		{
			...
			public class commands
			{
				...
				/// <summary>Executes a command. Some commands can take a list of objects as parameter. Refer to \ref globalcommandsids for the available commands.</summary>
				public const string execute = "ak.wwise.ui.commands.execute";
				/// <summary>Register an array of add-on commands. Registered commands remain until the Wwise process is terminated. Refer to \ref defining_custom_commands for more information about registering commands. Also refer to \ref ak_wwise_ui_commands_executed.</summary>
